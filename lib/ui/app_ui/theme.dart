...
class MyTheme {
  ...
  static ThemeData get standard {
    return ThemeData(
      ...
      dialogBackgroundColor: MyColors.whiteBackground,
  ...
  /// `ThemeData` for My UI for medium screens.
  static ThemeData get medium {
    return standard.copyWith(textTheme: _smallTextTheme);
  }

  /// `ThemeData` for My UI for large screens.
  ...
  static AppBarTheme get _appBarTheme {
    return const AppBarTheme(color: MyColors.primary);
  }
  ...
  static TabBarTheme get _tabBarTheme {
    return const TabBarTheme(
      ...
      unselectedLabelColor: MyColors.black25,
